...
// app/solanapayWidget/page.tsx

const USDC_MINT_DEVNET = new PublicKey(
  process.env.NEXT_PUBLIC_USDC_MINT ||
    "4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU"
); // <--- Add this missing ); here
  ...
  useEffect(() => {
    const generateQrCode = async () => {
      ...
      try {
        ...
        const qrSvg = await createQR(url.toString(), 200, "#0f172a", "#cbd5e1");
      ...
      <div className="w-full max-w-6xl">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs sm:text-sm">
                  Send to any Solana address • Powered by LazorKit
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 flex-1">
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3">
                <p className="text-purple-300 text-xs">
                  🔒 Secure blockchain transfer • Send to any Solana address •
                  Powered by LazorKit Smart Wallets
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    {paymentStatus === "processing" ? (
                      ...
                      <>
                        <Wallet className="w-5 h-5" />
                        <span>
                          Send {parseFloat(amount || "0").toFixed(4)}{" "}
                          {selectedToken}
                        </span>
        ...
        <div className="mt-6 text-center">
          <p className="text-slate-500 text-xs">
            Powered by Solana Commerce Kit & LazorKit • Devnet Environment •
