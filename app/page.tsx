      ...
      <div className="hero-content flex-col lg:flex-row-reverse gap-12">
        ...
        <div className="max-w-md">
          ...
          <p className="py-6 text-lg opacity-80">
            LazorKit lets you build <span className="font-semibold">seedless Solana applications</span> using 
    Face ID, Touch ID, and Windows Hello. No seed phrases. No extensions. 
    Just secure smart wallets powered by WebAuthn.
          </p>
